...
export const metadata: Metadata = {
  ...
  description: "Memperkenalkan sebuah bento box yang menawarkan hidangan Jepang asli yang praktis dan lezat.",
  openGraph: {
    title: "Bentodesu - Perfect Bentobox",
    description: "Hidangan Jepang asli yang praktis dan lezat.",
    images: [
      {
        url: "/img/sample3.png",
        width: 800,
        ...
        <section className="justify-center flex relative laptop:flex-row flex-col-reverse items-center w-full">
          <div className="laptop:w-1/2 flex flex-col justify-center gap-10 items-center laptop:items-start">
            ...
            <p className="size-subheading">
              ...
              kecintaan kami terhadap tradisi Jepang yang diwariskan dari generasi ke generasi. Dari bahan-bahan segar
              dan berkualitas hingga penyajian yang artistik, setiap elemen berperan dalam menciptakan pengalaman
              bersantap yang lengkap dan autentik.
            </p>
            <div className="">
        ...
        >
          <div className="desktop:w-[70%] flex flex-col gap-5 justify-center items-center text-center z-10 ">
            ...
            <p className="size-subheading laptop:px-16 px-5">
              ...
              dengan senang hati membantu Anda mendapatkan bento favorit Anda. Pesan sekarang, karena kelezatan menanti
              di setiap gigitan!
            </p>
