...
export const MenuBentoItem = ({ number, image, title, description }: MenuBentoItemProps) => {
  return (
    <div className="flex min-h-[800px] items-center relative laptop:flex-row flex-col">
